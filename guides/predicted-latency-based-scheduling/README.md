...
- **Problem:** Utilization-based load balancing misses the disticnt characteristics of LLM workloads, leading to SLO blind spots or overly conservative routing that wastes capacity capacity. 
